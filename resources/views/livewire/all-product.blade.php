...
<x-slot name="header">
                        ...
                        @foreach ( $products as $product)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    ...
                                    <button @click="$dispatch('edit-mode',{id:{{$product->id}}})" type="button" class="btn btn-primary" id="defaultModalButton" data-modal-toggle="defaultModal" >Edit</button>
    ...
    @this.on('refresh-products',(event)=>{
      ...
      var myModalEl=document.querySelector('#defaultModal')
